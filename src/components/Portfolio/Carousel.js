      ...
      <div class="col-span-12 lg:col-span-8">
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-2 sm:gap-5 lg:mt-6 lg:gap-6 xl:grid-cols-3">
          <div class="card">
            ...
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between">
              <div class="flex justify-end p-3">
                <button class="btn h-7 w-7 rounded-full bg-black/20 p-0 hover:bg-black/30 focus:bg-black/30">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="rounded-lg bg-gradient-to-t from-[#19213299] via-[#19213266] to-transparent px-4 py-3 pt-14">
                <div>
                  <a
                    href="#"
              ...
              <div class="rounded-lg bg-gradient-to-t from-[#19213299] via-[#19213266] to-transparent px-4 py-3 pt-14">
                ...
                <div class="mt-1 flex items-center space-x-3 text-slate-200">
                  <p class="flex items-center space-x-1">
                    ...
                    <span class="text-xs+ line-clamp-1">Unated States</span>
                  </p>
                  <p class="flex shrink-0 items-center space-x-1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="card">
            <img
              class="h-80 w-full rounded-lg object-cover"
              src="images/travel/travel-7.jpg"
              alt="image"
            />
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between">
              <div class="flex justify-end p-3">
          ...
          <div class="card">
            <img
              class="h-80 w-full rounded-lg object-cover"
              src="images/travel/travel-9.jpg"
              alt="image"
            />
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between">
              <div class="flex justify-end p-3">
          ...
          <div class="card">
            <img
              class="h-80 w-full rounded-lg object-cover"
              src="images/travel/travel-8.jpg"
              alt="image"
            />
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between">
              <div class="flex justify-end p-3">
